 ...
 */
public class ModelePrescNominativeDatasBuilderTest extends AbstractEclipseJUnitTest {
    /**
     * Builder testé.
     */
    ...
    public void setUp() {
        ...
        this.builder = new ModelePrescNominativeDatasBuilder();
    ...
    public void testBuildDataSource() {
        ...
        final String expectedSousTitre = "Prescription nominative de médicament en expérimentation clinique";
        final String expectedProcessus = "Métier pôle Pharmacie-Stérilisation\\Dispensation";
        ...
        Mockito.when(this.mockedJrDsFactory.getInitializedObject(Matchers.any(Object[].class))).thenAnswer(new Answer<JRDataSource>() {
            ...
            public JRDataSource answer(final InvocationOnMock invocation) throws Throwable {
                ...
                final JRBeanModelePrescNominative bean = (JRBeanModelePrescNominative) arg0;
