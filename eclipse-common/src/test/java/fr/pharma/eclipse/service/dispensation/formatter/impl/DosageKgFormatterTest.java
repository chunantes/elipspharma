 ...
 */
public class DosageKgFormatterTest extends AbstractEclipseJUnitTest {

    /**
     * Formatter à tester.
     */
    private DosageKgFormatter formatter;
    ...
    public void setUp() {
        ...
        this.formatter = new DosageKgFormatter();
    ...
    public void testFormat() {
        ...
        Mockito.when(patient.getPoid()).thenReturn(10.0);
