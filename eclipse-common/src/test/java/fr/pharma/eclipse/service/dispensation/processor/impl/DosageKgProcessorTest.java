 ...
 */
public class DosageKgProcessorTest extends AbstractEclipseJUnitTest {

    /**
     * Processor à tester.
     */
    private DosageKgProcessor processor;
    ...
    public void setUp() {
        ...
        this.processor = new DosageKgProcessor();
    ...
    public void testProcess() {
        ...
        Mockito.when(patient.getPoid()).thenReturn(69.1);
        final Conditionnement conditionnement = new Conditionnement();
        conditionnement.setModePrescription(ModePrescription.DOSE_KG);
        ...
        Assert.assertTrue(2100 == conseils.getNbASortir());
    }
