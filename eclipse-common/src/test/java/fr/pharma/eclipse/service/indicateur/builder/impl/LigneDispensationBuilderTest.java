 ...
 */
public class LigneDispensationBuilderTest extends AbstractEclipseJUnitTest {
    /**
     * Builder.
     */
    private LigneDispensationBuilder builder;
    ...
    public void setUp() {
        ...
        this.builder = new LigneDispensationBuilder();
    ...
    public void testBuild() {
        ...
        Assert.assertEquals(new BigDecimal(3), indicateur.getValeur());
    }
}
