 ...
 */
public class EssaiDispensationBuilderTest extends AbstractEclipseJUnitTest {
    /**
     * Builder.
     */
    private EssaiDispensationBuilder builder;
    ...
    public void setUp() {
        ...
        this.builder = new EssaiDispensationBuilder();
