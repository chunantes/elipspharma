...
/**
 * Filler en charge de valoriser les attributs de destinataires de dispensation de
 * {@link JRBeanFicheAideDispensationPart4}.
 
 * @version $Revision$ $Date$
 */
public class AideDispensationPart4DestDispFiller
    implements JasperReportBeanFiller
{
                     ...
                     final JasperReportBean bean)
    {
        ...
        this.buildLibelle(libelles,
                          infosDispensation.getDestinataireService(),
                          "Service");
        this.buildLibelle(libelles,
                          infosDispensation.getDestinatairePatient(),
                          "Patient ou représentant du patient");
        this.buildLibelle(libelles,
                          infosDispensation.getDestinataireInvestigateur(),
                          "Investigateur");
    ...
    /**
     * Méthode en charge d'ajouter un libellé, si besoin, à la liste passée en paramètre.
