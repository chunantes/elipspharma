 ...
 */
public class AideDispensationPart2ProduitsFiller
    implements JasperReportBeanFiller
{
    ...
    /**
     * Constructeur.
     * @param produitsPropertyFromEssai Nom de la propriété de la liste des produits<br>
     * à introspecter depuis l'essai.
     * @param jrPropertyToSet Propriété du JasperReportBean valorisée par ce filler. renseigner.
     */

    public AideDispensationPart2ProduitsFiller(
                                          final String produitsPropertyFromEssai,
                     ...
                     final JasperReportBean bean)
    {
        ...
        // Beans produits.
        final Collection<JRBeanProduit> beansProduit =
            this.helper.transform((Set<Produit>) BeanTool
                    .getPropriete(essai,
                                  this.produitsPropertyFromEssai));

        // Création de la source de données.
        final JRDataSource dataSource =
            this.jrDataSourceFactory.getInitializedObject(beansProduit);
        BeanTool.setPropriete(part2,
