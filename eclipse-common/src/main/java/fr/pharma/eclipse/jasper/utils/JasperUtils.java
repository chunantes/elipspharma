...
public final class JasperUtils
{
     ...
     * @return titre + prénom + nom de l'investigateur (valeur par défaut si investigateur nul).
     */
    public static String makeLibelleInvestigateur(final Investigateur investigateur)
    {
        ...
        return new StringBuilder()
                .append(investigateur.getTitre())
                .append(" ")
                .append(investigateur.getPrenom())
                .append(" ")
                .append(investigateur.getNom())
                .toString();
    }
     ...
     * @param jasperKey La clé (peut être obtenue en utilisant la fonction getKey).
    ...
    /**
     * Crée une chaine avec les libellés contenus dans la liste séparés par le séparateur
     * JasperConstants.SEPARATEUR_LIBELLES.
     * @param listeLibelles Liste des libellés.
     * @return Les libellés formattés (chaine vide si la liste est nulle ou vide).
     */
    public static String formatterListeStrings(final Collection<String> listeLibelles)
    {
        final StringBuffer res = new StringBuffer();
        if (listeLibelles != null
            && !listeLibelles.isEmpty())
        {
    ...
    /**
     * Méthode en charge de transformer un booléen en chaîne de caractères intelligible.
    ...
    /**
     * Donne la source de données Jasper relative à la collection donnée en paramètre.
