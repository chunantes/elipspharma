 ...
 */
public class PreparationEntreeFactory extends MvtStockFactory<PreparationEntree> implements ApproFactory<PreparationEntree> {
    ...
    public PreparationEntreeFactory(final Class<PreparationEntree> bean) {
        super(bean, TypeMvtStock.PREPARATION_ENTREE);
    }
