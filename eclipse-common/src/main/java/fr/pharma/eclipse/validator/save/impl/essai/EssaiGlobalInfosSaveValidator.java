 ...
 */
public class EssaiGlobalInfosSaveValidator
    implements SaveValidator<Essai>, Serializable
{
                         ...
                         final GenericService<Essai> essaiService)
    {
        ...
        {
            throw new ValidationException("essai.service",
                                          new String[]
                                          {"notEmpty" },
                                          essai);
        }
        ...
        {
            throw new ValidationException("essai.codePromoteur",
                                          new String[]
                                          {"notEmpty" },
                                          essai);
        }
        ...
        {
            throw new ValidationException("essai.nom",
                                          new String[]
                                          {"notEmpty" },
                                          essai);
        }
        ...
        {
            throw new ValidationException("essai.promoteur",
                                          new String[]
                                          {"notEmpty" },
                                          essai);
        }
        ...
        {
            throw new ValidationException("essai.typePromoteur",
                                          new String[]
                                          {"notEmpty" },
                                          essai);
        }
        ...
        {
            throw new ValidationException("essai.pharmaciePrincipale",
                                          new String[]
                                          {"notEmpty" },
                                          essai);
        }
