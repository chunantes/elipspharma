 ...
 */
public class PharmacieSaveValidator
    implements SaveValidator<Pharmacie>, Serializable
{
    /**
     * Serial ID.
     */
                         ...
                         final GenericService<Pharmacie> pharmacieService)
    {
        ...
        if (sites.isEmpty())
        {
            throw new ValidationException("pharmacie.sites",
                                          new String[]
                                          {"notEmpty" },
                                          pharmacie);
        }

        // Vérification de la concordance entre Etablissement de la pharmacie et Etablissements
