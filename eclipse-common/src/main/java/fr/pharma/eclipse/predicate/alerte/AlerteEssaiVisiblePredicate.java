...
/**
 * Predicat permettant de savoir si un essai est visible dans la gestion des alertes.
 
 * @version $Revision$ $Date$
 */
public class AlerteEssaiVisiblePredicate
    implements Predicate
{
    ...
    public boolean evaluate(final Object object)
    {
        ...
        return essai.getAlerteActive()
               && !EtatEssai.ARCHIVE.equals(etat);
    }
}
