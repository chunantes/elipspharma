...
/**
 * Classe en charge de retourner si oui ou non, l'essai est lié à une des pharmacie du pharmacien
 * de référence.
 
 * @version $Revision$ $Date$
 */
public class EssaiForPharmacienPredicate
...

{
    ...
    public boolean evaluate(final Object object)
    {
        ...
        {
            return CollectionUtils.containsAny(essai.getDetailDonneesPharma().getPharmacies(),
