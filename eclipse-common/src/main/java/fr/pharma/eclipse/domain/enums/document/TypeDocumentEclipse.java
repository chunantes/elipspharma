...
public enum TypeDocumentEclipse
{
    ...
    /**
     * Nom spécifique du répertoire de stockage de ces types de documents, relatif à la base
     * définie dans les propriétés de l'application.
     */
    private String repertoire;

    /**
     * Constructeur.
     * @param repertoire Nom spécifique du répertoire de stockage de ces types de documents,
