 ...
 */
public class DispensationProduitSearchCriteriaMaker extends AbstractCriteriaMaker {
    /**
     * Serial Id
     */
    ...
    public void transform(final Criteria criteria,
        ...
        final DispensationProduitSearchCriteria crit = (DispensationProduitSearchCriteria) searchCrit;
        // Essai
        ...
        // jointure entre des mvts de type 'dipensation' et des mvts de type
        // 'preparation entree'
        if (crit.getJointureEntreMvtDispensationEtPreparationEntree()) {
            if (crit.getTypeMouvement().equals(TypeMvtStock.DISPENSATION)) {
                ...
                mvtPreparationEntreeCriteria.add(Restrictions.eq("type", TypeMvtStock.PREPARATION_ENTREE));
                mvtPreparationEntreeCriteria.add(Restrictions.eq("numLot", crit.getNumLot()));
            }
