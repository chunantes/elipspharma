...
/**
 * Artisan de recherche pour les mouvements de stock de type 'preparations entree'.
 
 * @version $Revision$ $Date$
 */
public class PreparationEntreeSearchCriteriaMaker
    extends AbstractCriteriaMaker
{
                          ...
                          final SearchCriteria searchCrit)
    {
        ...
        // Numéros de lot
        if (crit.getNumLots() != null
            && crit.getNumLots().size() > 0)
        {
            CriteriaMakerUtils.addInCritere(criteria,
                                            "numLot",
                                            crit.getNumLots().toArray());
        }
