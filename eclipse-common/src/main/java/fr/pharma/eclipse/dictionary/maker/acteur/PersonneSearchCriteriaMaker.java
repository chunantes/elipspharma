 ...
 */
public class PersonneSearchCriteriaMaker
    extends AbstractCriteriaMaker
{
                          ...
                          final SearchCriteria searchCrit)
    {
        ...
        if (crit.getEssai() != null
            && crit.getDateDebut() != null
            & crit.getDateFin() != null)
        {
            final Criteria critHabilitations = criteria.createCriteria("habilitations",
                                                                       "habilitations");
            this.setMaxDate(crit.getDateFin());
            final Disjunction dis = Restrictions.disjunction();
            dis.add(Restrictions.ge("dateDesactivation",
                                    crit.getDateDebut()));
            dis.add(Restrictions.isNull("dateDesactivation"));
            critHabilitations.add(Restrictions.le("dateCreation",
                                                  crit.getDateFin()));
