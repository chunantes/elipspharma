 ...
 */
public class DesignHelper implements Serializable {
    ...
    /**
     * Méthode en charge de retourner tous les bras de l'essai qui n'ont pas de
     * parent.
     * @param essai Essai.
    ...
    public Set<Designable> getDesignRoots(final Essai essai) {
        ...
        CollectionUtils.filter(designRoot, new Predicate() {
            @Override
    ...
    /**
     * Retourne une chaine de caractères contenant la liste des noms des bras du
     * design.
     * @param essai L'essai.
