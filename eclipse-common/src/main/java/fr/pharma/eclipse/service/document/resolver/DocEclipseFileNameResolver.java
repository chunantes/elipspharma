...
/**
 * Interface des classe en charge de résoudre la nom de l'objet File
 * représentant un document Eclipse.
 * @author Netapsys
 * @version $Revision$ $Date$
 */
public interface DocEclipseFileNameResolver extends Serializable {
    /**
     * Méthode qui indique si le résolveur prend en charge un document.
     * @param doc Document à traiter.
     * @return True ssi le résolveur est capable de prendre en charge la
     * résolution de nom du document.
     */
     ...
     * @param doc Document dont on souhaite résoudre le nom de l'objet File
     * correspondant.
