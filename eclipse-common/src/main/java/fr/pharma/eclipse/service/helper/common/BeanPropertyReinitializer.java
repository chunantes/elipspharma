 ...
 */
public class BeanPropertyReinitializer<BEAN extends Object>
    implements Serializable
{
     ...
     * @param propertyPathFromBean Accès à la propriété à réinitialiser pour instrospection depuis
     * le bean.
     */
                                    ...
                                    final String propertyPathFromBean)
    {
        BeanTool.setPropriete(bean,
                              propertyPathFromBean,
                              null);
    }

    /**
     * Méthode qui vide une collection dans un bean. Ne fait rien si la propriété est nulle.
     * @param bean Bean à modifier.
     * @param propertyPathFromBean Accès à la collection à réinitialiser pour instrospection
     * depuis le bean.
     */
                                ...
                                final String propertyPathFromBean)
    {
        final Collection<? extends Object> collection =
            (Collection<? extends Object>) BeanTool.getPropriete(bean,
                                                                 propertyPathFromBean);
        if (collection == null)
        {
            return;
