...
/**
 * Classe en charge de formatter le conseil pour un conditionnement de type Dosage au kg.
 
 * @version $Revision$ $Date$
 */
public class DosageKgFormatter
    ...
    implements ConseilFormatter, Serializable
{
    ...
    public String format(final ConseilDispensation conseil)
    {
        ...
        buff
                .append(this.formatPoids(conseil))
    ...
    private String formatPoids(final ConseilDispensation conseil)
    {
        ...
        args[0] =
            conseil.getProduitPrescrit().getPrescription().getInclusion().getPatient().getPoid();
        return this.messageBuilder.getMessage("conseil.dispensation.dose.poids",
                                              args);
    }
    ...
    private String formatNbDoses(final ConseilDispensation conseil)
    {
        ...
        return this.messageBuilder.getMessage("conseil.dispensation.dose.poids.nbDoses",
                                              args);
    }
