 ...
 */
public interface OrdonnancierService<BEAN extends Ordonnancier> extends GenericService<BEAN> {

    /**
     * Méthode en charge de récupérer la date de début du prochain ordonnancier
     * de la pharmacie. La date de début est Date de fin du précédent + 1 ou
     * 01/01/2011 si pas de précédent.
    ...
    /**
     * Méthode en charge de calculer l'ordonnancier de dispensation pour une
     * pharmacie.
     * @param criteria Critère de recherche portant les informations pour le
     * calcul.
