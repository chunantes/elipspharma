...
/**
 * Interface définissant le comportement des processor de cout variables
 * spécifique en fonction du mode de calcul.
 * @author Netapsys
 * @version $Revision$ $Date$
 */
public interface VariableSubProcessor {
    /**
     * Méthode en charge de calculer le montant d'un cout reel à partir d'une
     * regle et des informations en paramètre.
     * @param item L'item.
    ...
    Resultat process(Item item,
                     ...
                     Calendar dateFin);
    /**
     * Méthode en charge de calculer le montant d'un cout previsionnel à partir
     * d'une regle et des informations en paramètre.
     * @param item L'item.
     * @param regle La regle.
     * @param essai L'essai.
