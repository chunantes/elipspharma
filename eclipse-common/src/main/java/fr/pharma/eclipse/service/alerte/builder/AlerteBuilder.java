...
public interface AlerteBuilder {
    /**
     * Méthode en charge de construire les alertes en prenant en compte les
     * essais et les pharmacies accessibles pour l'utilisateur.
     ...
     */
    void build(final List<EssaiAlerte> essais,
