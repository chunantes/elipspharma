...
/**
 * Classe en charge de compter le nombre de destructions pour un essai ou un patient dans un
 * essai.
 
 * @version $Revision$ $Date$
 */
public class DestructionCounter
    ...
    implements ActeCounter, Serializable
{
    ...
    /**
     * Méthode en charge de compter le nombre de destructions pour l'essai (ou pour le patient si
    ...
    {
        return super.process(TypeEvenement.DESTRUCTION,
                             null,
                             essai,
                             patient,
                             dateDebut,
