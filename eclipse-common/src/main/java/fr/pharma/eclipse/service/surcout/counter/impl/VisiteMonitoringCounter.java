...
/**
 * Classe en charge de compter le nombre de visites de monitoring pour un essai.
 
 * @version $Revision$ $Date$
 */
public class VisiteMonitoringCounter
    ...
    implements ActeCounter, Serializable
{
    ...
    /**
     * Méthode en charge de compter le nombre de visites de monitoring pour l'essai dans
    ...
    /**
     * Méthode en charge de compter le nombre de destructions prévisionnels pour l'essai. Le
     * nombre de destructions par patient n'est pas accessible.
     * @param essai L'essai.
     * @param patient Le patient (si null alors le calcul se fait pour l'essai).
                       ...
                       final DonneesPrevision prevision)
    {
        ...
        return prevision.getNbVisiteMonitoring();
    }
