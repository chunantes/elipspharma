 ...
 */
public class VisiteMonitoringCounter extends EvenementCounter implements ActeCounter, Serializable {
    /**
     * Serial UID.
     */
    ...
    /**
     * Méthode en charge de compter le nombre de visites de monitoring pour
     * l'essai dans l'intervalle en paramètre.
     * @param essai L'essai.
    ...
    public int process(final Essai essai,
        ...
        return super.process(TypeEvenement.VISITE, TypeVisite.SUIVI_PHAMACIE, essai, patient, dateDebut, dateFin).size();
    }
