 ...
 */
public class TauNonDispensationBuilder
    ...
    implements IndicateurBuilder, Serializable
{
                            ...
                            final Calendar dateFin)
    {
        ...
        final List dispensations = this.loadDispensations(pharmacie,
                                                          ...
                                                          dateFin,
                                                          false);
        final List total = this.loadDispensations(pharmacie,
                                                  dateDebut,
                                                  dateFin,
                                                  null);
        ...
        CollectionUtils.transform(total,
                                  new LigneDispensationTransformer());
        ...
        else
        {
            result =
                new BigDecimal(LigneDispensationTransformer.getTotal(dispensations))
                        .divide(new BigDecimal(LigneDispensationTransformer.getTotal(total)),
                                3,
