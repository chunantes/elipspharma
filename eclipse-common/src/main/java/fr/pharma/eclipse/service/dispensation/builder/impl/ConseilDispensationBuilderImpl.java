 ...
 */
public class ConseilDispensationBuilderImpl
    implements ConseilDispensationBuilder, Serializable
{
    ...
    /**
     * Liste de checker à appliquer sur le produit prescrit lors de l'exécution de la méthode
     * support.
     */
    private List<Checker<ProduitPrescrit>> checkers;

    /**
     * Stratégie de processor en charge de calculer le conseil à la dispensation.
     */
    ...
    public ConseilDispensation build(final ProduitPrescrit produitPrescrit)
    {
        return this.processors
                .get(produitPrescrit.getConditionnement().getModePrescription())
                .process(produitPrescrit);
    }
    ...
    public boolean support(final ProduitPrescrit produitPrescrit)
    {
        ...
        return result
               && this.processors.containsKey(produitPrescrit
                       .getConditionnement()
                       .getModePrescription());
    }
    ...
    {
        return this.formatters.get(conseil
                .getProduitPrescrit()
                .getConditionnement()
                .getModePrescription()).format(conseil);
    }
