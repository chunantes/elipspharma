...
/**
 * Interface définissant le comportement d'un fabriquant de conseils de dispensation.
...
{
    /**
     * Méthode en charge de vérifier si le produit prescrit fourni supporte les calculs
     * nécessaires à la construction du conseil.
     * @param produitPrescrit Le produit prescrit.
     * @return <true> si le produit prescrit contient les informations nécessaires à la
     * construction d'un conseil.
     */
    boolean support(ProduitPrescrit produitPrescrit);

    /**
     * Méthode en charge de construire les conseils à la dispensation à partir du produit
     * prescrit.
     * @param produitPrescrit Le produit prescrit.
    ...
    /**
     * Méthode en charge d'appeler le formatter associé au mode de prescriptin du conseil.
