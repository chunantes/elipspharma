...
import fr.pharma.eclipse.predicate.pharmacie.PharmacieEssaiElementPredicate;
...
/**
 * Implémentation pour l'indicateur de mise en place. Il compte le nombre de visite de mise en
 * place durant la période.
 
 * @version $Revision$ $Date$
 */
public class GenericEvenementBuilder
    implements IndicateurBuilder, Serializable
{
                            ...
                            final Calendar dateFin)
    {
        ...
        CollectionUtils.filter(evenements,
                               new PharmacieEssaiElementPredicate(pharmacie));

        return new Indicateur(this.libelle,
                              new BigDecimal(evenements.size()));
    }
    /**
     * Setter pour service.
