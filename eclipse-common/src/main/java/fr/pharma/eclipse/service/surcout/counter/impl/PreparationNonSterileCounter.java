...
/**
 * Classe en charge de compter le nombre de preparations non steriles pour un
 * essai ou un patient dans un essai.
 * @author Netapsys
 * @version $Revision$ $Date$
 */
public class PreparationNonSterileCounter extends PreparationCounter implements ActeCounter, Serializable {
    ...
    /**
     * Méthode en charge de compter le nombre de preparations non steriles pour
    ...
    public int process(final Essai essai,
        ...
        return super.process(essai, patient, dateDebut, dateFin, false);
    }
