...
/**
 * Interface commune des processors en charge de compter le nombre d'actes d'un essai ou d'un
 * patient.
...
{
    /**
     * Méthode en charge de calculer le nombre d'acte par essai ou par patient (si patient !=
     * null).
     * @param essai L'essai.
