...
public final class Utils {
    ...
    /**
     * Méthode en charge de formater une date en utilisant le formatage passé en
     * paramètre.
    ...
    public static String formatDate(final Date date,
        ...
        return Utils.formatDate(date, pattern, null);
    }
    /**
     * Méthode en charge de formater une date en utilisant le formatage passé en
     * paramètre.
    ...
    public static String formatDate(final Calendar calendar,
        ...
        return Utils.formatDate(calendar.getTime(), pattern, defaultValue);
    }
    ...
    /**
     * Fonction en charge de parser une date et de renvoyer le Calendar
     * correspondant.
    ...
    /**
     * Fonction en charge de créer un calendrier positionné au premier jour de
     * l'année donnée.
    ...
    public static Calendar getCalendarForFirstDayOfYear(final int year) {
        return Utils.getCalendarForYear(year, -1);
    }

    /**
     * Fonction en charge de créer un calendrier positionné au dernier jour de
     * l'année donnée.
     * @param year Année sur laquelle positionner le calendrier.
     * @return Le calendar positionné.
     */
    ...
    /**
     * Fonction en charge de créer un calendrier positionné à la première ou la
     * dernière date d'une année.
     * @param year Année sur laquelle positionner le calendrier.
     * @param mode si supérieur ou égal à 0, positionne au 31/12/year; si
     * inférieur à 0, positionne au 01/01/year.
     * @return Le calendar positionné.
     */
    ...
    /**
     * Méthode en charge de transformer la stackTrace d'une exception en chaîne
     * de caractères (pour la mettre dans les logs par exemple).
     * @param throwable Exception à traiter.
     * @return La chaîne de caractères correspondant à la stackTrace de
     * l'exception.
     */
