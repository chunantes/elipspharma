...
/**
 * Classe en charge de convertir un bean en un bean du modèle. Il procède en 3 étapes : 1 - Il
 * appelle la factory du bean métier, 2 - il appliquer un fetcher en charge de remplir les
 * propriétés simples, 3- Il applique des fillers pour les propriétés plus complexes.
 
 * @version $Revision$ $Date$
 * @param <BEANTECH> Type du bean source.
 * @param <BEAN> Type du bean métier destination.
 */
public class GenericBeanConverter<BEANTECH extends Object, BEAN extends BeanObject>
    implements BeanConverter<BEANTECH, BEAN>
{
    ...
    public GenericBeanConverter(
                                final GenericFetcher<BEANTECH, BEAN> fetcher,
                                final BeanObjectFactory<BEAN> factory)
    {
