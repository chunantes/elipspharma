...
/**
 * Interface des filler en charge d'insérer les données d'un bean technique SIGREC dans un bean
 * métier.
...
{
    /**
     * Méthode en charge d'insérer des données d'un bean technique dans un bean métier.
    ...
    /**
     * Retourne <code>true</code> si le filler est capable de traiter l'élément en entrée.
     * @param source Le bean source.
     * @return <code>true</code> si le filler est capable de traiter l'élément en entrée.
     */
