...
/**
 * Filler en charge de populer les assurance d'un essai à partir d'un essai sigrec.
    ...
    implements Filler<EssaiSigrec, Essai>
{
                     ...
                     final Essai destination)
    {
        ...
        {
            this.assuranceFetcher.fetch(source.getAssurances().get(0),
                                        destination.getDetailAdministratif().getInfosAssurance());
        }
    }
