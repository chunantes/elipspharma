 ...
 */
public class ProduitPrescritComparator
    implements Comparator<ProduitPrescrit>, Serializable
{
    /**
     * Serial ID.
     */
    ...
    private String buildKey(final ProduitPrescrit p)
    {
        ...
        builder.append(p.getConditionnement().getModePrescription().getLibelle())
