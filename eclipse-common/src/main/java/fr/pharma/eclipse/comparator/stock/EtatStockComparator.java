 ...
 */
public class EtatStockComparator implements Comparator<EtatStock>, Serializable {
    /**
     * Serial ID.
     */
    ...
    public int compare(final EtatStock etatStock1,
        ...
        sb1.append(essai1.getNumInterne()).append(essai1.getNom()).append(etatStock1.getPharmacie().getNom()).append(etatStock1.getProduit().getDenomination())
                .append(etatStock1.getConditionnement().getLibelle());

        final StringBuilder sb2 = new StringBuilder();
        sb2.append(essai2.getNumInterne()).append(essai2.getNom()).append(etatStock2.getPharmacie().getNom()).append(etatStock2.getProduit().getDenomination())
