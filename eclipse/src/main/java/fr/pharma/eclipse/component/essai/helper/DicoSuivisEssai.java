 ...
 */
public class DicoSuivisEssai implements Serializable {
     ...
     */
    private final Map<TypeHistoriqueEssai, Suivi> derniersHistoriques = new TreeMap<TypeHistoriqueEssai, Suivi>();
    ...
    public void init(final Essai essai) {
        ...
        this.derniersHistoriques.put(TypeHistoriqueEssai.GENERAL, this.helper.getFirstOfCollection(essai.getModifs()));
        this.derniersHistoriques.put(TypeHistoriqueEssai.ONG_RECHERCHE, this.helper.getFirstOfCollection(essai.getDetailRecherche().getModifs()));
        this.derniersHistoriques.put(TypeHistoriqueEssai.ONG_CONTACTS, this.helper.getFirstOfCollection(essai.getDetailContacts().getModifs()));
        this.derniersHistoriques.put(TypeHistoriqueEssai.ONG_FAISABILITE, this.helper.getFirstOfCollection(essai.getDetailFaisabilite().getModifs()));
        this.derniersHistoriques.put(TypeHistoriqueEssai.ONG_DATES, this.helper.getFirstOfCollection(essai.getDetailDates().getModifs()));
    ...
    /**
     * Méthode pour indiquer si le dictionnaire possède entrée non nulle pour le
     * type donné.
     * @param ongletEssai Type de la modification à récupérer.
     * @return true ssi le dictionnaire possède entrée non nulle pour le type
     * donné.
     */
    public boolean hasDerniereModif(final TypeHistoriqueEssai ongletEssai) {
        return this.derniersHistoriques.containsKey(ongletEssai) && (this.derniersHistoriques.get(ongletEssai) != null);
    }

    /**
     * Méthode en charge de récupérer la dernière modification d'un certain
     * type.
