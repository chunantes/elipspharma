 ...
 */
public class ConditionnementManager extends BeanManager<Conditionnement> {
    ...
    /**
     * Méthode en charge de populer les propriétés du conditionnement courant en
    ...
    public void handleUniteGestion(final AjaxBehaviorEvent event) {
        ...
        if ((value != null) && value.equals(UniteGestion.KIT)) {
    ...
    /**
     * Méthode appelée par l'IHM lors de la sélection d'une voie
     * d'administration.
     * @param event Evenement JSF.
     */
    ...
    /**
     * Méthode en charge de construire l'unité de prescription du
     * conditionnement.
     */
    public void buildUnitePrescription() {
        if (this.getBean().getModePrescription() != null && this.getBean().getUniteGestion() != null) {
