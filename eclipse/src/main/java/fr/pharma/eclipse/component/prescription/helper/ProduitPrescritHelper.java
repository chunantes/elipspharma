...
public class ProduitPrescritHelper
{
    ...
    {"debut", "debut.unite", "debut.nb", "duree", "duree.unite", "duree.nb", "frequence",
     "frequence.nbFrequence", "frequence.typeRegularite", "frequence.uniteFrequence",
    ...
    public String buildResume(final ProduitPrescrit prescription)
    {
                               ...
                               this.proprietes))
        {
            ...
            {
                buff.append(prescription.getNbUniteDosage())
                        .append(" fois ")
            ...
            {
                buff.append(prescription.getFrequence().getTypeRegularite())
                        .append(EclipseConstants.SPACE);
            };
            if (prescription.getFrequence().getTypeRegularite().equals(TypeRegularite.TOUS_LES))
            {
                buff.append(prescription.getFrequence().getNbUniteTempsFrequence())
                        .append(EclipseConstants.SPACE);
            }
            if (!prescription.getFrequence().getTypeRegularite().equals(TypeRegularite.FOIS))
            {
                buff.append(prescription.getFrequence().getUniteFrequence().getLibPluriel())
                        .append(EclipseConstants.SPACE);
            }
