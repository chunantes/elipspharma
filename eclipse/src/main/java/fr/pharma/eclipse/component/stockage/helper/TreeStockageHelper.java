...
/**
 * Classe de helper concernant la représentation sous forme d'arbre des stockages d'une pharmacie.
 
 * @version $Revision$ $Date$
 */
public class TreeStockageHelper
    implements Serializable
{
    ...
    /**
     * Méthode en charge de construire les données de l'arbre de stockages d'une pharmacie.
    ...
    public TreeNode buildTree(final Pharmacie pharmacie)
    {
        ...
        {
            final TreeNode nodeParent = new DefaultTreeNode(stockageRoot,
                                                            root);
     ...
     * @param stockage Bean stockage de référence dans l'arbre pour gérer l'ouverture des noeuds.
    ...
    /**
     * Méthode en charge de calculer l'identifiant du noeud correspondant au stockage.
     * @param node Noeud.
    ...
    /**
     * Méthode en charge de retourner tous les stockages de la pharmacie qui n'ont pas de parent.
     * @param pharmacie Pharmacie.
     * @return Liste des stockages root (ceux qui n'ont pas de parent - niveau 1.
     */
    protected SortedSet<Stockage> getStockagesRoot(final Pharmacie pharmacie)
    {
        ...
        CollectionUtils.filter(stockagesRoot,
                               new Predicate() {
                                   @Override
    ...
    protected String decomposeNodes(final String input)
    {
        ...
        {
            result += TreeStockageHelper.NAME_TREE_STOCKAGES
                      + tmp
