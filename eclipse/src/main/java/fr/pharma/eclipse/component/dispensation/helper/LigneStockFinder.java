...
/**
 * Interface commune définissant la recherche de lignes de stocks pour une dispensation en
 * fonction du type de dispensation (GLobale / Nominative).
...
{
    /**
     * Méthode en charge d'intiailiser les lignes de stocks dans le SortieManager.
