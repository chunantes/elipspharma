 ...
 */
public class RetoursPatientManager<BEAN extends RetourPatient>
    extends BeansManager<BEAN>
{
     ...
     */
    public RetoursPatientManager(final SearchCriteria searchCriteria)
    {
    ...
    /**
     * Méthode en charge d'appliquyer le changement d'état à tous les beans sélectionnés.
     */
            ...
            DocumentException
    {
        this.getDocProcessor().preProcessPDF(document,
                                             "Formulaire de retour : Récapitulatif par patient");
    }
    ...
    public void preProcessXLS(final Object document)
        throws IOException,
            ...
            DocumentException
    {
        this.getDocProcessor().preProcessXLS(document,
                                             "Formulaire de retour : Récapitulatif par patient");
    }
