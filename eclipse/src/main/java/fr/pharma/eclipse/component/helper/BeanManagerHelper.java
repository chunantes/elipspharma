...
/**
 * Classe de helper pour les traitements génériques nécessaires au management
 * des beans métier.
 * @param <BEAN> Type d'objets générique.
 * @author Netapsys
 * @version $Revision$ $Date$
 */
public class BeanManagerHelper<BEAN extends BeanObject> implements Serializable {
    ...
    /**
     * Méthode en charge de marquer comme sélectionnés les beans de selectable
     * qui apparaissent dans selected.
     * @param <CHILD> Type d'objet générique des éléments de la liste à mettre à
     * jour.
    ...
    /**
     * Méthode en charge de marquer comme sélectionnés les beans wrappés de
     * selectable qui apparaissent dans selected.
     * @param <CHILD> Type d'objet générique des éléments de la liste à mettre à
     * jour.
     * @param selected Liste des éléments de référence.
     * @param selectableBeans Liste des éléments sélectionnables (wrappés) à
     * mettre à jour.
     */
     ...
     * jour.
     * @param selected Liste des éléments à mettre à jour.
     * @param selectableBeans selectableBeans Liste des éléments sélectionnables
     * (wrappés) de reférence.
     */
    ...
    public <CHILD extends BeanObject> void addToCollection(final BEAN bean,
        ...
        this.beanHelper.addToCollection(bean, beanCollectionProperty, childToAdd);
    }
    ...
    /**
     * Méthode en charge de retourner la liste des objets métier sélectionnés
     * dans une liste.
