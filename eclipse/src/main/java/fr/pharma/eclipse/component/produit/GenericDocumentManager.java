 ...
 */
public class GenericDocumentManager<DOC extends DocumentProduit> implements Serializable {
     ...
     * une valeur de l'énumération {@link TypeDocumentProduit}.
     */
     ...
     * @return Un nouveau DocumentProduit. Le fichier physique est créé sur le
     * disque.
     */
    @SuppressWarnings("unchecked")
    public DOC createDocument(final Produit produit) {
        // Document BDD.
        final DOC doc = this.factory.getInitializedObject(this.fichier, produit);

        // Document Physique.
        this.docService.saveOnDisk(produit, doc, this.fichier);
