 ...
 */
public class ConditionnementsManager
    extends BeansManager<Conditionnement>
{
     ...
     */
    public ConditionnementsManager(final SearchCriteria searchCriteria)
    {
