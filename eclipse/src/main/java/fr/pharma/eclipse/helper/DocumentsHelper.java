    ...
    implements Serializable
{
    ...
    /**
     * Méthode en charger de construire le message de l'info-bulle du nom d'un document.
                                ...
                                final String patternDate)
    {
        ...
        if (doc != null)
        {
            builder.append(messageAjouteLe).append(" ").append(Utils
                    .formatDate(doc.getDateMaj().getTime(),
                                patternDate));
