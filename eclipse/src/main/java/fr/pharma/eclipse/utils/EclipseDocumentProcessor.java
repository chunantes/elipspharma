 ...
 */
public class EclipseDocumentProcessor
    implements Serializable
{
    ...
    private static Font catFont = new Font(Font.TIMES_ROMAN,
                                           18,
                                           Font.BOLD);
            ...
            DocumentException
    {
        ...
        final Paragraph preface = new Paragraph(titre,
                                                EclipseDocumentProcessor.catFont);
        preface.setAlignment(Element.ALIGN_CENTER);
        // We add one empty line
        EclipseDocumentProcessor.addEmptyLine(preface,
                                              3);
        pdf.add(preface);
    }
