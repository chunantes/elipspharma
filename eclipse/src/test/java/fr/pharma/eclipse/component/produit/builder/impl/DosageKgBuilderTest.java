 ...
 */
public class DosageKgBuilderTest extends AbstractEclipseJUnitTest {

    /**
     * Builder.
     */
    private DosageKgBuilder builder;
    ...
    @Override
    public void setUp() {
        this.builder = new DosageKgBuilder();
    }
    ...
    public void testBuild() {
        ...
        Assert.assertEquals("cp/kg", conditionnement.getUnitePrescription());
    }
