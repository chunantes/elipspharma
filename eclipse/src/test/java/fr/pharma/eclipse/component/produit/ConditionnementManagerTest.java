...
public class ConditionnementManagerTest
{
    ...
    public void init()
    {
        ...
        final Map<ModePrescription, UnitePrescriptionBuilder> map =
            new HashMap<ModePrescription, UnitePrescriptionBuilder>();
        map.put(ModePrescription.CONDITIONNEMENT_PRIMAIRE,
                this.builder);
    ...
    public void testInit()
    {
        ...
        Assert.assertEquals("",
                            this.conditionnementManager.getResume());
    }
    ...
    public void testEditConditionnement()
    {
        ...
        Mockito.when(this.helper.buildResume(Matchers.any(Conditionnement.class)))
                .thenReturn("resume");
        this.conditionnementManager.editConditionnement(conditionnement);
        Assert.assertEquals(this.conditionnementManager.getBean(),
                            conditionnement);
        Assert.assertEquals("resume",
                            this.conditionnementManager.getResume());
    }
    ...
    public void testHandleForme()
    {
        ...
        Mockito.when(menu.getLocalValue())
                .thenReturn(FormeConditionnement.CONDITIONNEMENT_PRIMAIRE);
        ...
        Assert.assertEquals(FormeConditionnement.CONDITIONNEMENT_PRIMAIRE,
                            this.conditionnementManager.getBean().getForme());
    }
    ...
    public void testHandleVoieAdministration()
    {
        ...
        Assert.assertEquals(VoieAdministration.BOLUS,
                            this.conditionnementManager.getBean().getVoieAdministration());
    }
    ...
    public void testHandleUniteGestion()
    {
        ...
        Assert.assertEquals(UniteGestion.BOITE,
                            this.conditionnementManager.getBean().getUniteGestion());
    }
    ...
    public void testHandleUniteGestionKit()
    {
        ...
        Assert.assertEquals(UniteGestion.KIT,
                            this.conditionnementManager.getBean().getUniteGestion());
        Assert.assertEquals(FormeConditionnement.CONDITIONNEMENT_PRIMAIRE,
                            this.conditionnementManager.getBean().getForme());
    }
    ...
    public void testBuildUnitePrescriptionNull()
    {
        ...
        Mockito.verify(this.builder,
                       Mockito.never()).build(Matchers.any(Conditionnement.class));
    }
    ...
    public void testBuildUnitePrescriptionOk()
    {
        ...
        this.conditionnementManager.buildUnitePrescription();
        Mockito.verify(this.builder,
                       Mockito.times(1)).build(Matchers.any(Conditionnement.class));
    }
}
