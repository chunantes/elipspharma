 ...
 */
public class PharmaciensSeekerTest
    extends AbstractEclipseJUnitTest
{
    ...
    public void testGetSearchCriteria()
    {
        ...
        final List<Pharmacien> expectedList = Arrays.asList(personne1,
                                                            personne2);
        ...
        essai.getDetailDonneesPharma().getPharmacies().addAll(Arrays.asList(pharmaCo1,
                                                                            pharmaCo2));

        final PharmacienSearchCriteria expectedCriteria =
            Mockito.mock(PharmacienSearchCriteria.class);
        Mockito
        ...
        Mockito.doAnswer(new Answer<Object>() {
                ...
                throws Throwable
            {
                ...
                .when(expectedCriteria)
                .setPharmacies(Matchers.anyListOf(Pharmacie.class));
