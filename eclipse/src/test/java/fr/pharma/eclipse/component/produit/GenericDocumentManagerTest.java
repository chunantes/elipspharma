...
public class GenericDocumentManagerTest
{
    ...
    public void setUp()
    {
        ...
        this.manager =
            new GenericDocumentManager<DocumentRandomisation>(GenericDocumentManagerTest.TYPE_DOC_MANAGE
                    .name());
    ...
    public void testCreateDocument()
    {
        ...
        Mockito
                .when(this.mockedFactory
                        .getInitializedObject(Matchers.any(Fichier.class),
                                              Matchers.any(DispositifMedical.class)))
                .thenReturn(expectedDoc);

        final DocumentProduit actualDoc = this.manager.createDocument(produit);
        Mockito
                .verify(this.mockedFactory)
                .getInitializedObject(Matchers.any(Fichier.class),
                                      Matchers.any(DispositifMedical.class));
        Mockito.verify(this.mockedDocService).saveOnDisk(Matchers.any(DispositifMedical.class),
                                                         Matchers.any(DocumentEclipse.class),
