...
public class GenericStockManagerTest
{
    ...
    public void testInit()
    {
        ...
        Assert.assertEquals(TypeDocumentStock.APPRO,
    ...
    public void testCreateDocument()
    {
        ...
        Mockito.when(this.mockFactory.getInitializedObject(fichier,
                                                           mvtStock)).thenReturn(expectedDoc);

        final DocumentStock actualDoc = this.manager.createDocument(mvtStock);
        Mockito.verify(this.mockFactory).getInitializedObject(fichier,
                                                              mvtStock);
        Mockito.verify(this.mockDocService).saveOnDisk(mvtStock,
                                                       expectedDoc,
                                                       fichier);
    ...
    public void testSetFile()
    {
        ...
        Mockito.doAnswer(answer).when(this.mockFiller).fill(Matchers.any(UploadedFile.class),
                                                            Matchers.any(Fichier.class));
        this.manager.setFile(file);
        Mockito.verify(this.mockFiller).fill(Matchers.any(UploadedFile.class),
                                             Matchers.any(Fichier.class));
    }
    ...
    public void testSetFileNull()
    {
        ...
        Mockito.verify(this.mockFiller,
