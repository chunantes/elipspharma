 ...
 */
public class RetourPatientManagerTest extends AbstractEclipseJUnitTest {
    ...
    public void testHandleSelectEssai() {
        Mockito.when(this.patientService.getAllPatientsForEssai(Matchers.any(Essai.class))).thenReturn(new ArrayList<Patient>());

        Mockito.when(this.essaiService.getAllPharmacies(Matchers.any(Essai.class))).thenReturn(new ArrayList<Pharmacie>());
        this.manager.setEssaiSelected(new Essai());
    ...
    public void testHandleSelectPharmacie() {
        ...
        Mockito.when(this.produitService.getProduits(Matchers.any(Essai.class), Matchers.any(Pharmacie.class))).thenReturn(new ArrayList<Produit>());
    ...
    public void testHandleSelectProduit() {
        ...
        Mockito.when(this.produitService.reattach(Matchers.any(Produit.class))).thenReturn(new Medicament());
    ...
    public void testHandleSelectPatient() {
        ...
        Mockito.when(this.dispensationService.getAll(Matchers.any(SearchCriteria.class))).thenReturn(new ArrayList<Dispensation>());
    ...
    public void testHandleSelectConditionnement() {
        ...
        Mockito.when(this.produitService.reattach(Matchers.any(Produit.class))).thenReturn(medicament);
