 ...
 */
public class ProduitPrescritManagerTest
    extends AbstractEclipseJUnitTest
{
    ...
    {
        Mockito.when(this.produitPrescritFactory.getInitializedObject())
                .thenReturn(new ProduitPrescrit());
    ...
    public void testEditProduitPrescrit()
    {
        ...
        Mockito.when(this.helper.buildResume(Matchers.any(ProduitPrescrit.class)))
                .thenReturn("test");
        value.put("produitCurrent",
                  new ProduitPrescrit());
