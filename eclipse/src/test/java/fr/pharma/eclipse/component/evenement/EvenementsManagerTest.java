 ...
 */
public class EvenementsManagerTest
{
    /**
     * EvenementsManager à tester.
     */
    private EvenementsManager manager;
    ...
    public void init()
    {
        ...
        this.manager = new EvenementsManager(this.criteria);
    }
    ...
    public void testHandleSelectTypeEvenementVisite()
    {
        ...
        Assert.assertEquals(TypeVisite.AUDIT_EXTERNE,
                            this.criteria.getTypeVisite());
        Assert.assertEquals(ResultatVisite.EFFECTUE,
                            this.criteria.getResultatVisite());
    }
    ...
    public void testInitSchedule()
    {
        ...
        Assert.assertEquals(1,
                            this.manager.getEventModel().getEventCount());
    }
