 ...
 */
public class ConditionnementsManagerTest
    extends AbstractEclipseJUnitTest
{
     ...
     * Manager à tester.
     */
    private ConditionnementsManager conditionnementsManager;
    ...
    public void setUp()
    {
        ...
        this.conditionnementsManager = new ConditionnementsManager(this.criteria);
    ...
    public void testInit()
    {
        ...
        Assert.assertEquals(this.criteria,
                            this.conditionnementsManager.getSearchCriteria());
    ...
    public void testAddWithoutId()
    {
        ...
        this.conditionnementsManager.add(produit,
                                         conditionnement);
        Assert.assertTrue(produit
                .getConditionnements()
                .first()
                .getId()
                .equals(conditionnement.getId()));
    ...
    public void testRemove()
    {
        ...
        Mockito.when(this.mockedRemoveValidator.validate(Matchers.any(Conditionnement.class)))
                .thenReturn(true);

        Mockito.when(this.mockedHelper.getBeansSelected(Matchers.anyCollection()))
                .thenReturn(result);
        ...
        Assert.assertEquals(1,
                            produit.getConditionnements().size());
    }
