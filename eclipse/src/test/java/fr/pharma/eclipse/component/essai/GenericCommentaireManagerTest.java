...
public class GenericCommentaireManagerTest
{
    ...
    public void setUp()
    {
        ...
        this.manager =
            new GenericCommentaireManager(GenericCommentaireManagerTest.TYPE_COMMENTAIRE.name());
    ...
    public void testInit()
    {
        ...
        Assert.assertEquals(GenericCommentaireManagerTest.TYPE_COMMENTAIRE,
                            this.manager.getTypeCommentaire());
    }
    ...
    public void testCreateCommentaire()
    {
        ...
        Mockito
                .when(this.mockedFactory.getInitializedObject(detailRecherche))
        ...
        Assert.assertEquals(expectedCommentaire.getId(),
                            commentaireResult.getId());
        Assert.assertEquals(expectedCommentaire.getMajPar(),
                            commentaireResult.getMajPar());
        Assert.assertEquals(expectedCommentaire.getDateMaj(),
                            commentaireResult.getDateMaj());
        Assert.assertEquals(libelle.trim(),
                            commentaireResult.getLibelle());
        Assert.assertEquals(StringUtils.EMPTY,
                            this.manager.getLibelle());
    }
    ...
    public void testInitLastCommentaireEmptyList()
    {
        ...
        final CommentaireEssaiRecherche initialLastCommentaire =
        ...
        Assert.assertEquals(initialLastCommentaire,
                            this.manager.getLastCommentaire());
     ...
     * @throws ParseException En cas d'erreur de préparation des jeux de données.
     */
    @Test
    public void testInitLastCommentaire()
        throws ParseException
    {
        ...
        final SortedSet<CommentaireEssaiRecherche> commentaires =
        ...
        commentaires.add(EssaiUtils
                .makeCommentaireTest(ids++,
                                     Utils.parseDate("01/03/2010",
                                                     EclipseConstants.PATTERN_SIMPLE)));
        commentaires.add(EssaiUtils
                .makeCommentaireTest(ids++,
                                     Utils.parseDate("01/01/2010",
                                                     EclipseConstants.PATTERN_SIMPLE)));
