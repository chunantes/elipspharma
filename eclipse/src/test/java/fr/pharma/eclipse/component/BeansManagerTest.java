...
public class BeansManagerTest
{
     ...
     */
    private BeansManager<Pharmacie> pharmaciesManager;
    ...
    public void init()
    {
        ...
        this.pharmaciesManager = new BeansManager<Pharmacie>(this.criteria);
    ...
    public void testGetBeansSelected()
    {
        ...
        expectedList.add(PharmacieUtils.makePharmacieTest(id++));
        Mockito.when(this.mockedHelper.getBeansSelected(this.pharmaciesManager.getBeans()))
