 ...
 */
public class EssaiListManagerTest {

    /**
     * Manager à tester.
     */
    private EssaiListManager essaisManager;
    ...
    @Before
    public void init() {
        this.essaisManager = new EssaiListManager(new EssaiSearchCriteria());
    ...
    /**
     * Méthode en charge de tester la récupération de l'investigateur principal
     * KO.
     */
    @Test
    public void testGetInvestigateurPrincipalKO() {
        ...
        Mockito.when(this.mockEssaiService.get(essai.getId())).thenReturn(essai);
        ...
        Assert.assertEquals(StringUtils.EMPTY, this.essaisManager.getInvestigateurPrincipal(essai));
    }
    ...
    public void testGetInvestigateurPrincipalOK() {
        ...
        Mockito.when(essai.getDetailContacts()).thenReturn(detailContacts);
        Mockito.when(detailContacts.getHabilitations()).thenReturn(habilitations);
        Assert.assertEquals("nom" + EclipseConstants.SPACE + "prenom", this.essaisManager.getInvestigateurPrincipal(essai));
    }
