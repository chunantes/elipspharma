...
public class CalendarConverterTest
{
    ...
    {
        Assert.assertNull(this.converter.getAsObject(this.mockedContext,
                                                     this.mockedUiComponent,
                                                     ""));
        Assert.assertNull(this.converter.getAsObject(this.mockedContext,
                                                     this.mockedUiComponent,
                                                     "1/1"));
    ...
    public void testGetAsObject()
    {
        ...
        final Object res = this.converter.getAsObject(this.mockedContext,
                                                      this.mockedUiComponent,
                                                      expectedValue);
        Assert.assertTrue(res instanceof Calendar);
        Assert.assertEquals(expectedValue,
                            Utils.formatDate(((Calendar) res).getTime(),
    ...
    {
        Assert.assertNull(this.converter.getAsString(this.mockedContext,
                                                     this.mockedUiComponent,
                                                     null));
        Assert.assertNull(this.converter.getAsString(this.mockedContext,
                                                     this.mockedUiComponent,
        ...
        throws ParseException
    {
        ...
        Assert
                .assertEquals(expectedValue,
                              this.converter
                                      .getAsString(this.mockedContext,
                                                   this.mockedUiComponent,
                                                   Utils
                                                           .parseDate(expectedValue,
                                                                      EclipseConstants.PATTERN_SIMPLE)));
